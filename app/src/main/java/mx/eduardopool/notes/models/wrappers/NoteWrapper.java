package mx.eduardopool.notes.models.wrappers;
 ...
 */
public class NoteWrapper extends BaseObservable implements Parcelable {
    public static final Parcelable.Creator<NoteWrapper> CREATOR = new Parcelable.Creator<NoteWrapper>() {
        public NoteWrapper createFromParcel(Parcel source) {
            return new NoteWrapper(source);
        }

        public NoteWrapper[] newArray(int size) {
            return new NoteWrapper[size];
        }
    };
    private String id;
